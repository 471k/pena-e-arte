...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Live Traffic",     href: "/platform/traffic",          icon: <Activity        className="h-4 w-4" />, tourId: "admin-traffic-nav" },
  { label: "Studios",          href: "/platform/studios",          icon: <Building2       className="h-4 w-4" />, tourId: "admin-studios-nav" },
  { label: "Plans",            href: "/platform/plans",            icon: <CreditCard      className="h-4 w-4" />, tourId: "admin-plans-nav" },
  { label: "Subscriptions",    href: "/platform/subscriptions",    icon: <Receipt         className="h-4 w-4" />, tourId: "admin-subscriptions-nav" },
  ...
  { label: "Conduct Reports",  href: "/platform/conduct-reports",  icon: <ShieldAlert     className="h-4 w-4" />, tourId: "admin-conduct-reports-nav" },
  { label: "Help Insights",    href: "/platform/help-insights",    icon: <HelpCircle      className="h-4 w-4" /> },
  { label: "Audit Log",        href: "/platform/audit-log",        icon: <ScrollText      className="h-4 w-4" />, tourId: "admin-audit-log-nav" },
];
