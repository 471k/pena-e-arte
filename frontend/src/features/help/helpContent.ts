...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "You can also delete from an artist's own profile page: click the \"⋯\" button next to \"Edit\", choose \"Delete\", and confirm.",
    ],
    tips: [
      "If you also tattoo, look for \"Enable my artist profile\" near the top of this page.",
      "An artist's profile page has six tabs — Profile, Portfolio, Availability (their weekly working hours and time off), Bookings, Designs and Social. The tab you're on is kept in the page address, so refreshing or sharing the link brings you back to it.",
    ],
