...
export const HELP_ARTICLES: HelpArticle[] = [
  // ── Client ──────────────────────────────────────────────────────────────
  {
    ...
    route: "/book",
    keywords: ["booking", "request", "artist", "schedule a tattoo", "new appointment", "reference images", "area photo", "upload photo", "let studio choose", "any artist", "studio picks artist", "tattoo description", "referral source", "how did you hear", "desired placement", "body map", "guest", "no account", "sign up", "promo code", "discount code"],
    ...
    steps: [
      ...
      "Describe what you're looking to get done, and optionally pick how you heard about the studio and add any safety notes (medical conditions, allergies, medications, skin concerns).",
