...
function makeStore() {
  return configureStore({
    ...
    preloadedState: {
      ...
      auth: { user: { id: "u-001", email: "owner@test.com" }, token: "fake-token", tenantId: "s-001", role: "owner", pendingReferralCode: null, impersonation: null } as any,
    ...
    server.use(
      http.put("http://localhost/api/v1/payments/:id/splits", async ({ request }) => {
        ...
        return HttpResponse.json({
          ...
          providerReferenceId: null, clientToken: null,
