...
import "./index.css";
// POK's checkout widget (GuestCheckoutForm) ships its own stylesheet, scoped under
// #pok-payment-container — imported once here per the SDK's own guidance.
import "@nebula-ltd/pok-payments-js/index.css";
