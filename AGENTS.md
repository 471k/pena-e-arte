# AGENTS.md — Tattoo Studio SaaS

> Primary reference for Codex. Read this first, then load the relevant
> file from `docs/Codex/` for the layer you are working on.
...
|---|---|
| Backend / API | `docs/Codex/backend.md` |
| Frontend / React | `docs/Codex/frontend.md` |
| Database / EF Core | `docs/Codex/database.md` |
| Architecture patterns | `docs/Codex/architecture.md` |
| Coding conventions | `docs/Codex/conventions.md` |
...
├── AGENTS.md
├── docs/
│   └── Codex/                       ← per-layer instruction files
│       ├── backend.md
│       ├── frontend.md
│       ├── database.md
│       ├── architecture.md
...
6. **Match current industry standards — for every tenant/role.** Every feature or
   ...
   built for. See `docs/Codex/architecture.md`'s "Industry-Standard Benchmark" note
...
7. **Keep Help in sync — every time.** Every feature added or changed must update,
   ...
   Help describes it correctly. See `docs/Codex/architecture.md`'s "In-App Help
