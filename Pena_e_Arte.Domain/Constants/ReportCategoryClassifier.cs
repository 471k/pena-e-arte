...
/// things: whether filing the report fires the immediate owner+admin email
/// (ConductReportNotifier), and whether an owner (as opposed to only the admin) is permitted
