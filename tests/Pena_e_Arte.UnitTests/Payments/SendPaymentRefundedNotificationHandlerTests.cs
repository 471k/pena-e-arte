...
public class SendPaymentRefundedNotificationHandlerTests
{
    ...
    public SendPaymentRefundedNotificationHandlerTests() =>
        _emailRenderer
            .RenderPaymentRefunded(Arg.Any<string>(), Arg.Any<string>(), Arg.Any<bool>())
            .Returns("<html>refund</html>");

    private SendPaymentRefundedNotificationHandler CreateSut() =>
    ...
    public async Task Handle_ValidInput_SendsEmailToClient()
    {
        ...
        await CreateSut().Handle(new SendPaymentRefundedNotificationCommand(paymentId), default);
    ...
    {
        await CreateSut().Handle(new SendPaymentRefundedNotificationCommand(Guid.NewGuid()), default);
    ...
    public async Task Handle_EmailFails_DoesNotThrow()
    {
        ...
        Func<Task> act = () => CreateSut().Handle(new SendPaymentRefundedNotificationCommand(paymentId), default);
