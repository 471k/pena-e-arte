    ...
    ILogger<AppointmentReminderJob>  logger)
{
    public async Task SendReminderAsync(Guid appointmentId, string type, CancellationToken ct = default)
    {
        ...
        db.NotificationLogs.Add(BuildLog(appointment, NotificationChannel.Email, subject, emailBody, emailSuccess));
        ...
        if (appointment.Client.Phone is not null)
        {
            ...
            db.NotificationLogs.Add(BuildLog(appointment, NotificationChannel.Sms, null, smsBody, smsSuccess));
        }
