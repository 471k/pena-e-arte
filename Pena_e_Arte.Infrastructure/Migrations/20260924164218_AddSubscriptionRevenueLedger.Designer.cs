...
namespace Pena_e_Arte.Infrastructure.Migrations
{
    ...
    [Migration("20260924164218_AddSubscriptionRevenueLedger")]
    partial class AddSubscriptionRevenueLedger
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pena_e_Arte.Domain.Entities.SavedPaymentMethod", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<string>("ProviderCardTokenId")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("varchar(200)");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_saved_payment_methods");

                    b.HasIndex("ClientId");

                    b.HasIndex("StudioId")
                        .HasDatabaseName("ix_saved_payment_methods_studio_id");

                    b.HasIndex("StudioId", "ClientId", "ProviderCardTokenId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Pena_e_Arte.Domain.Entities.StudioApiKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("StudioId")
                        .HasDatabaseName("ix_studio_api_keys_studio_id");

                    b.ToTable("studio_api_keys", (string)null);
                });
            ...
            modelBuilder.Entity("Pena_e_Arte.Domain.Entities.Subscription", b =>
                {
                    ...
                    b.Property<int?>("BilledQuantity")
                        .HasColumnType("int");

                    b.Property<decimal?>("BilledUnitAmount")
                    ...
                    b.Property<decimal?>("RecurringDiscountPercent")
                        .HasColumnType("decimal(5,2)");
            ...
            modelBuilder.Entity("Pena_e_Arte.Domain.Entities.SubscriptionInvoicePayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<decimal?>("MonthlyReferencePrice")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_subscription_invoice_payments");

                    b.HasIndex("PaidAt")
                        .HasDatabaseName("ix_subscription_invoice_payments_paid_at");

                    b.HasIndex("StripeInvoiceId")
                        .IsUnique()
                        .HasDatabaseName("ix_subscription_invoice_payments_stripe_invoice_id");

                    b.HasIndex("StudioId")
                        .HasDatabaseName("ix_subscription_invoice_payments_studio_id");

                    b.HasIndex("SubscriptionId");

                    b.ToTable("subscription_invoice_payments", (string)null);
                });

            modelBuilder.Entity("Pena_e_Arte.Domain.Entities.SubscriptionRefund", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<Guid>("SubscriptionInvoicePaymentId")
                        .HasColumnType("char(36)");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_subscription_refunds");

                    b.HasIndex("StudioId")
                        .HasDatabaseName("ix_subscription_refunds_studio_id");

                    b.HasIndex("SubscriptionId");

                    b.HasIndex("SubscriptionInvoicePaymentId")
                        .IsUnique()
                        .HasDatabaseName("ix_subscription_refunds_subscription_invoice_payment_id");

                    b.ToTable("subscription_refunds", (string)null);
                });

            modelBuilder.Entity("Pena_e_Arte.Domain.Entities.SubscriptionRevenueEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<decimal>("MrrAfter")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");

                    b.Property<decimal>("MrrBefore")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_subscription_revenue_events");

                    b.HasIndex("OccurredAt")
                        .HasDatabaseName("ix_subscription_revenue_events_occurred_at");
                    ...
                    b.HasIndex("SubscriptionId")
                        .HasDatabaseName("ix_subscription_revenue_events_subscription_id");

                    b.ToTable("subscription_revenue_events", (string)null);
                });
            ...
            modelBuilder.Entity("Pena_e_Arte.Domain.Entities.WebhookDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("StudioId")
                        .HasDatabaseName("ix_webhook_deliveries_studio_id");

                    b.HasIndex("WebhookEndpointId", "AttemptedAt")
                        .HasDatabaseName("ix_webhook_deliveries_endpoint_attempted_at");

                    b.ToTable("webhook_deliveries", (string)null);
                });

            modelBuilder.Entity("Pena_e_Arte.Domain.Entities.WebhookEndpoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("StudioId")
                        .HasDatabaseName("ix_webhook_endpoints_studio_id");
            ...
            modelBuilder.Entity("Pena_e_Arte.Domain.Entities.SubscriptionInvoicePayment", b =>
                {
                    b.HasOne("Pena_e_Arte.Domain.Entities.Subscription", "Subscription")
                        .WithMany()
            ...
            modelBuilder.Entity("Pena_e_Arte.Domain.Entities.SubscriptionRefund", b =>
                {
                    b.HasOne("Pena_e_Arte.Domain.Entities.Subscription", "Subscription")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_subscription_refunds_subscriptions");
            ...
            modelBuilder.Entity("Pena_e_Arte.Domain.Entities.SubscriptionRevenueEvent", b =>
                {
                    b.HasOne("Pena_e_Arte.Domain.Entities.Subscription", null)
                        .WithMany()
                        .HasForeignKey("SubscriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_subscription_revenue_events_subscriptions");
                });
